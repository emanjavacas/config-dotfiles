...
c.InteractiveShellApp.exec_lines.append('print("(Hello from ipython_config.py.) Warning: disable autoreload in ipython_config.py to improve performance.")')
...
#c.InteractiveShell.banner1 = "Python 3.6.8 (default, Dec 27 2018, 23:08:28) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.2.0 -- An enhanced Interactive Python. Type '?' for help.\n"
